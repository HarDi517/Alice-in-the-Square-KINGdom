    ...
    void Start()
    {
        switch (FirstMenu.stage)
        {
            ...
            case 1:
                ...
                contentText.text = "감성 넘치는 글귀가 가득한 서제에 다녀왔다. 특\n히 ‘너의 return값은 항상 1이야’ 라는 문구가 인\n상깊었다.이 근처에 유명한 카페가 있다고 한다! 거기로 가봐야지";
                break;
            case 2:
                placeText.text = "café HATTER";
                stageText.text = "Stage 3";
                contentText.text = "역시 유명한 카페로 가는 길은 험난하다. 힘들게 도착해도 다들 휴업이라고 하고 ㅠㅠ 포기할까 하\n던 중 영업 중인 café HATTER를 발견했다! 고생한\n만큼 좋은 카페였으면 좋겠다";
                break;
            case 3:
                placeText.text = "크리켓 경기장";
                stageText.text = "Stage 4";
                contentText.text = "원래 커피가 이렇게 비싼가…? 편히 쉬고 싶었는데 의자도 딱딱하고 식탁도 낮고 불편해서 그냥 나왔\n다. 저멀리 크리켓을 하는 사람들이 보인다. 오랜\n만에 운동 좀 해볼까?";
                break;
            case 4:
                placeText.text = "재판장";
                stageText.text = "Stage 5";
                contentText.text = "내가 무엇을 잘못했다는 건지 모르겠다. 다들 게\n임은 안하고 사진만 찍길래 우리 게임은 언제 하\n는거냐고 약간 불평했을 뿐인데… 갑자기 날 사형\n시키겠다고 한다! 이젠 그냥 집에 가고 싶다.";
                break;
            case 5:
                placeText.text = "우리 집";
                stageText.text = "엔딩";
                contentText.text = "정말 죽다 살아났다. 우리 집이 이렇게 반가울 줄\n이야. sns고 뭐고 이제 다 필요 없다. 일단 집에 가서 쉬어야 겠다. 근데 아까부터 누가 날 쳐다보\n는 것 같은데…?";
