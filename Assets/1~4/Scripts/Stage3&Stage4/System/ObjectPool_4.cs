            ...
            case "card":
                switch (Card[0].count)
                {
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        Card[5].obj.transform.localPosition = new Vector3(0.2543f, -177.955f, cardHeartPrefab.transform.position.z);
                        Card[5].obj.transform.rotation = Quaternion.Euler(0, 0, 0);
                        break;
                    case 15:
                        Card[3].obj.transform.localPosition = new Vector3(1.37f, -177.955f, cardHeartPrefab.transform.position.z);
                        Card[3].obj.transform.rotation = Quaternion.Euler(0, 0, 0);
                        break;
                    case 16:
                        Card[1].obj.transform.localPosition = new Vector3(0.2543f, -179.5f, cardHeartPrefab.transform.position.z);
                        Card[1].obj.transform.rotation = Quaternion.Euler(0, 0, 0);
                        break;
                    case 17:
                        Card[6].obj.transform.localPosition = new Vector3(1.37f, -179.5f, cardHeartPrefab.transform.position.z);
                        Card[6].obj.transform.rotation = Quaternion.Euler(0, 0, 0);
                        break;
                    case 18:
